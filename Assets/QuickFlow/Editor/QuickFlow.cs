...
namespace QuickFlow.Editor
{
    ...
    public class QuickFlowGroupFinder : MonoBehaviour
    {
        ...
        public static void QuickFlowWindow()
        {
            ...
            GroupFinderWindow.DisplayGroupFinderWindow();
    ...
    public class GroupFinderWindow : EditorWindow
    {
        ...
        public static void DisplayGroupFinderWindow()
        {
            ...
            var window = GetWindow<GroupFinderWindow>();

            window.minSize = new Vector2(300f, 470f);
